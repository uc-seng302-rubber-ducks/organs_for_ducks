...
public class DonationTabPageController {
    ...
    @FXML
    private Button organQualificationStatusChangerButton;
    ...
    @FXML
    private Button removeDisqualifiedOrgans;
    ...
    private void toggleDisqualifiedExpired(boolean goToExpiryMode) {
        ...
        if (goToExpiryMode) {
            ...
            removeDisqualifiedOrgans.setVisible(false);
        } else {
            ...
            removeDisqualifiedOrgans.setVisible(true);
        }
