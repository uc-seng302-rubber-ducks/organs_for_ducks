...
/**
 * subclass of Textfield to limit the number of characters allowed
 */
public class LimitedTextField extends TextField {

    public static final IntegerProperty RECCOMMENDED_LENGTH = new SimpleIntegerProperty(255);
    private final IntegerProperty maxLength;

    public LimitedTextField() {
        this(RECCOMMENDED_LENGTH.getValue());
    }

    public LimitedTextField(@NamedArg("maxLength") int maxLength) {
        super();
    ...
    public final void setMaxLength(Integer maxLength) {
        Objects.requireNonNull(maxLength, "Max length cannot be null. Use -1 for no limit");
