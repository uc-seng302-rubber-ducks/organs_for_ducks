...
public class RegisterTests {
  ...
  public void setup() {
    ...
    controller.setDonors(new ArrayList<>()); //reset donor list between tests
      ...
      minInfo = new Donor("John Doe", LocalDate.parse("1961-02-12",format));
      maxInfo = new Donor("Gus Johnson", LocalDate.parse("1990-04-03",format));
  ...
  public void ShouldRegisterDonorWithMaximumInfo() {
    ...
    registered = controller.findDonor("Gus Johnson", LocalDate.parse("1990-04-03",format));
