...
INSERT INTO BloodTestDetails (bloodTestId, redBloodCellCount, whiteBloodCellCount, haemoglobinLevel, platelets,
                              glucoseLevels, meanCellVolume, haematocrit, meanCellHaematocrit, requestedDate) VALUES
  (1, 0.0054, 8.5, 120.5, 300.5, 4.8, 80.5, 0.35, 25.5, '2015-09-01'),
  (2, 0.0063, 7.7, 127.6, 354.4, 5.3, 78.5, 0.35, 25.5, '2017-01-09');